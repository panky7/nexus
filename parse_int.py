...
input_file = open("/Users/JANINE/test123/run_int")
...
template = open("/Users/JANINE/test123/interface.template")
re_table = textfsm.TextFSM(template)
fsm_results = re_table.ParseText(raw_text_data)

# the results are written to a CSV file
datestring = datetime.strftime(datetime.now(),'%Y-%m-%d-%H-%M')
os.chdir(r'/Users/JANINE/test123')
outfile_name = open("nexus_run_interface.csv", "w+")
